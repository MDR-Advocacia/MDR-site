...
<style>
    ...
    /* --- CORREÇÃO PARA AS IMAGENS CORTADAS --- */
    .profile-image {
        width: 150px;
        height: 150px;
        object-fit: cover; 
    ...
    .ana-carolina-img {
        object-position: 20% 10%; /* Alinha a imagem pelo topo */
    }
    .denize-medeiros-img {
        object-position: 20% 10%; /* Alinha a imagem um pouco abaixo do topo */
    }
    /* --- FIM DA CORREÇÃO --- */
</style>
      ...
      <div class="professionals-grid">
        ...
        <div class="animar-ao-rolar" style="display: flex; align-items: flex-start; gap: 30px; margin-bottom: 30px; padding-bottom: 30px; border-bottom: 1px solid #b29d55;">
            <div style="flex-shrink: 0; display: flex; flex-direction: column; align-items: center;">
                ...
                <div style="display:flex; gap: 10px;">
                    <a href="https://www.linkedin.com/in/nat%C3%A1lia-linhares-a482b1267/" target="_blank" aria-label="LinkedIn de Natália Ribeiro Linhares" style="text-decoration: none; display: inline-block;"><svg viewBox="0 0 24 24" style="width: 24px; height: 24px; fill: #555;"><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.3v-1.11h-3.06v8.37h3.06v-4.93c0-.83.06-1.66.57-2.12.51-.46 1.28-.48 1.76 0 .5.47.48 1.3.48 2.12v4.93h3.06zM6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69.75 1.68 1.68 0 0 0 0 1.88 1.68 1.68 0 0 0 1.69.74zm-1.44 9.94h3.06v-8.37H5.44v8.37z"></path></svg></a>
                    <a href="https://www.instagram.com/nataliarlinhares" target="_blank" aria-label="Instagram de Natália Ribeiro Linhares" style="text-decoration: none; display: inline-block;"><svg viewBox="0 0 24 24" style="width: 24px; height: 24px; fill: #555;"><path d="M7.8,2H16.2C19.4,2 22,4.6 22,7.8V16.2A5.8,5.8 0 0,1 16.2,22H7.8C4.6,22 2,19.4 2,16.2V7.8A5.8,5.8 0 0,1 7.8,2M7.6,4A3.6,3.6 0 0,0 4,7.6V16.4C4,18.39 5.61,20 7.6,20H16.4A3.6,3.6 0 0,0 20,16.4V7.6C20,5.61 18.39,4 16.4,4H7.6M17.25,5.5A1.25,1.25 0 0,1 18.5,6.75A1.25,1.25 0 0,1 17.25,8A1.25,1.25 0 0,1 16,6.75A1.25,1.25 0 0,1 17.25,5.5M12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9Z"></path></svg></a>
                    <a href="https://wa.me/558421399916" target="_blank" aria-label="Whatsapp de Natália Ribeiro Linhares" style="text-decoration: none; display: inline-block;"><svg viewBox="0 0 24 24" style="width: 24px; height: 24px; fill: #555;"><path d="M16.75,13.96C17.0,14.21 17.2,14.5 17.2,14.86C17.2,15.22 17.05,15.57 16.8,15.82C16.55,16.07 16.21,16.22 15.85,16.22C15.31,16.22 13.8,15.77 12.04,14.22C10,12.41 8.7,10.27 8.7,9.81C8.7,9.35 8.85,9 9.1,8.75C9.35,8.5 9.6,8.35 9.96,8.35C10.32,8.35 10.6,8.5 10.85,8.75C11.1,9 11.3,9.29 11.3,9.65C11.3,10.01 11.15,10.36 10.9,10.61L10.5,11.01C10.3,11.21 10.11,11.4 10.35,11.65C10.59,11.9 11.23,12.54 11.96,13.27C12.91,14.22 13.54,14.58 13.9,14.58C14.26,14.58 14.5,14.38 14.7,14.18L15.1,13.78C15.35,13.53 15.7,13.38 16.06,13.38C16.42,13.38 16.77,13.53 17.02,13.78L17.47,14.23C17.22,14.48 16.97,14.73 16.75,13.96M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,4A8,8 0 0,1 20,12A8,8 0 0,1 12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4Z"></path></svg></a>
                </div>
            </div>
        ...
        <div class="animar-ao-rolar" style="display: flex; align-items: flex-start; gap: 30px; margin-bottom: 30px; padding-bottom: 30px; border-bottom: 1px solid #b29d55;">
          <div style="flex-shrink: 0; display: flex; flex-direction: column; align-items: center;">
              ...
              <div style="display:flex; gap: 10px;">
                  <a href="https://www.linkedin.com/in/ana-carolina-viana-nascimento-15845a372/" target="_blank" aria-label="LinkedIn de Ana Carolina Viana Nascimento" style="text-decoration: none; display: inline-block;"><svg viewBox="0 0 24 24" style="width: 24px; height: 24px; fill: #555;"><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.3v-1.11h-3.06v8.37h3.06v-4.93c0-.83.06-1.66.57-2.12.51-.46 1.28-.48 1.76 0 .5.47.48 1.3.48 2.12v4.93h3.06zM6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69.75 1.68 1.68 0 0 0 0 1.88 1.68 1.68 0 0 0 1.69.74zm-1.44 9.94h3.06v-8.37H5.44v8.37z"></path></svg></a>
                  <a href="https://www.instagram.com/carolinaviaana" target="_blank" aria-label="Instagram de Ana Carolina Viana Nascimento" style="text-decoration: none; display: inline-block;"><svg viewBox="0 0 24 24" style="width: 24px; height: 24px; fill: #555;"><path d="M7.8,2H16.2C19.4,2 22,4.6 22,7.8V16.2A5.8,5.8 0 0,1 16.2,22H7.8C4.6,22 2,19.4 2,16.2V7.8A5.8,5.8 0 0,1 7.8,2M7.6,4A3.6,3.6 0 0,0 4,7.6V16.4C4,18.39 5.61,20 7.6,20H16.4A3.6,3.6 0 0,0 20,16.4V7.6C20,5.61 18.39,4 16.4,4H7.6M17.25,5.5A1.25,1.25 0 0,1 18.5,6.75A1.25,1.25 0 0,1 17.25,8A1.25,1.25 0 0,1 16,6.75A1.25,1.25 0 0,1 17.25,5.5M12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9Z"></path></svg></a>
                  <a href="https://wa.me/5584991922986" target="_blank" aria-label="Whatsapp de Ana Carolina Viana Nascimento" style="text-decoration: none; display: inline-block;"><svg viewBox="0 0 24 24" style="width: 24px; height: 24px; fill: #555;"><path d="M16.75,13.96C17.0,14.21 17.2,14.5 17.2,14.86C17.2,15.22 17.05,15.57 16.8,15.82C16.55,16.07 16.21,16.22 15.85,16.22C15.31,16.22 13.8,15.77 12.04,14.22C10,12.41 8.7,10.27 8.7,9.81C8.7,9.35 8.85,9 9.1,8.75C9.35,8.5 9.6,8.35 9.96,8.35C10.32,8.35 10.6,8.5 10.85,8.75C11.1,9 11.3,9.29 11.3,9.65C11.3,10.01 11.15,10.36 10.9,10.61L10.5,11.01C10.3,11.21 10.11,11.4 10.35,11.65C10.59,11.9 11.23,12.54 11.96,13.27C12.91,14.22 13.54,14.58 13.9,14.58C14.26,14.58 14.5,14.38 14.7,14.18L15.1,13.78C15.35,13.53 15.7,13.38 16.06,13.38C16.42,13.38 16.77,13.53 17.02,13.78L17.47,14.23C17.22,14.48 16.97,14.73 16.75,13.96M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,4A8,8 0 0,1 20,12A8,8 0 0,1 12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4Z"></path></svg></a>
              </div>
          </div>
          <div style="flex: 1; min-width: 300px;">
        ...
        <div class="animar-ao-rolar" style="display: flex; align-items: flex-start; gap: 30px; margin-bottom: 30px; padding-bottom: 30px; border-bottom: 1px solid #b29d55;">
          <div style="flex-shrink: 0; display: flex; flex-direction: column; align-items: center;">
              ...
              <div style="display:flex; gap: 10px;">
                  <a href="https://www.linkedin.com/in/denize-medeiros-512970225/" target="_blank" aria-label="LinkedIn de Denize de Medeiros Silva" style="text-decoration: none; display: inline-block;"><svg viewBox="0 0 24 24" style="width: 24px; height: 24px; fill: #555;"><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.3v-1.11h-3.06v8.37h3.06v-4.93c0-.83.06-1.66.57-2.12.51-.46 1.28-.48 1.76 0 .5.47.48 1.3.48 2.12v4.93h3.06zM6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69.75 1.68 1.68 0 0 0 0 1.88 1.68 1.68 0 0 0 1.69.74zm-1.44 9.94h3.06v-8.37H5.44v8.37z"></path></svg></a>
                  <a href="https://www.instagram.com/denizemedeirosadv" target="_blank" aria-label="Instagram de Denize de Medeiros Silva" style="text-decoration: none; display: inline-block;"><svg viewBox="0 0 24 24" style="width: 24px; height: 24px; fill: #555;"><path d="M7.8,2H16.2C19.4,2 22,4.6 22,7.8V16.2A5.8,5.8 0 0,1 16.2,22H7.8C4.6,22 2,19.4 2,16.2V7.8A5.8,5.8 0 0,1 7.8,2M7.6,4A3.6,3.6 0 0,0 4,7.6V16.4C4,18.39 5.61,20 7.6,20H16.4A3.6,3.6 0 0,0 20,16.4V7.6C20,5.61 18.39,4 16.4,4H7.6M17.25,5.5A1.25,1.25 0 0,1 18.5,6.75A1.25,1.25 0 0,1 17.25,8A1.25,1.25 0 0,1 16,6.75A1.25,1.25 0 0,1 17.25,5.5M12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9Z"></path></svg></a>
                  <a href="https://wa.me/5584991922986" target="_blank" aria-label="Whatsapp de Denize de Medeiros Silva" style="text-decoration: none; display: inline-block;"><svg viewBox="0 0 24 24" style="width: 24px; height: 24px; fill: #555;"><path d="M16.75,13.96C17.0,14.21 17.2,14.5 17.2,14.86C17.2,15.22 17.05,15.57 16.8,15.82C16.55,16.07 16.21,16.22 15.85,16.22C15.31,16.22 13.8,15.77 12.04,14.22C10,12.41 8.7,10.27 8.7,9.81C8.7,9.35 8.85,9 9.1,8.75C9.35,8.5 9.6,8.35 9.96,8.35C10.32,8.35 10.6,8.5 10.85,8.75C11.1,9 11.3,9.29 11.3,9.65C11.3,10.01 11.15,10.36 10.9,10.61L10.5,11.01C10.3,11.21 10.11,11.4 10.35,11.65C10.59,11.9 11.23,12.54 11.96,13.27C12.91,14.22 13.54,14.58 13.9,14.58C14.26,14.58 14.5,14.38 14.7,14.18L15.1,13.78C15.35,13.53 15.7,13.38 16.06,13.38C16.42,13.38 16.77,13.53 17.02,13.78L17.47,14.23C17.22,14.48 16.97,14.73 16.75,13.96M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,4A8,8 0 0,1 20,12A8,8 0 0,1 12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4Z"></path></svg></a>
              </div>
          </div>
          <div style="flex: 1; min-width: 300px;">
        ...
        <div class="animar-ao-rolar" style="display: flex; align-items: flex-start; gap: 30px; margin-bottom: 30px; padding-bottom: 30px; border-bottom: 1px solid #b29d55;">
          <div style="flex-shrink: 0; display: flex; flex-direction: column; align-items: center;">
              <img src="assets/img/supervisores/diegoalves.jpg" alt="Diego Alves Nascimento" class="profile-image">
              <div style="display:flex; gap: 10px;">
                  <a href="#" target="_blank" aria-label="LinkedIn de Diego Alves Nascimento" style="text-decoration: none; display: inline-block;"><svg viewBox="0 0 24 24" style="width: 24px; height: 24px; fill: #555;"><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.3v-1.11h-3.06v8.37h3.06v-4.93c0-.83.06-1.66.57-2.12.51-.46 1.28-.48 1.76 0 .5.47.48 1.3.48 2.12v4.93h3.06zM6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69.75 1.68 1.68 0 0 0 0 1.88 1.68 1.68 0 0 0 1.69.74zm-1.44 9.94h3.06v-8.37H5.44v8.37z"></path></svg></a>
                  <a href="#" target="_blank" aria-label="Instagram de Diego Alves Nascimento" style="text-decoration: none; display: inline-block;"><svg viewBox="0 0 24 24" style="width: 24px; height: 24px; fill: #555;"><path d="M7.8,2H16.2C19.4,2 22,4.6 22,7.8V16.2A5.8,5.8 0 0,1 16.2,22H7.8C4.6,22 2,19.4 2,16.2V7.8A5.8,5.8 0 0,1 7.8,2M7.6,4A3.6,3.6 0 0,0 4,7.6V16.4C4,18.39 5.61,20 7.6,20H16.4A3.6,3.6 0 0,0 20,16.4V7.6C20,5.61 18.39,4 16.4,4H7.6M17.25,5.5A1.25,1.25 0 0,1 18.5,6.75A1.25,1.25 0 0,1 17.25,8A1.25,1.25 0 0,1 16,6.75A1.25,1.25 0 0,1 17.25,5.5M12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9Z"></path></svg></a>
                  <a href="https://wa.me/5584999990003" target="_blank" aria-label="Whatsapp de Diego Alves Nascimento" style="text-decoration: none; display: inline-block;"><svg viewBox="0 0 24 24" style="width: 24px; height: 24px; fill: #555;"><path d="M16.75,13.96C17.0,14.21 17.2,14.5 17.2,14.86C17.2,15.22 17.05,15.57 16.8,15.82C16.55,16.07 16.21,16.22 15.85,16.22C15.31,16.22 13.8,15.77 12.04,14.22C10,12.41 8.7,10.27 8.7,9.81C8.7,9.35 8.85,9 9.1,8.75C9.35,8.5 9.6,8.35 9.96,8.35C10.32,8.35 10.6,8.5 10.85,8.75C11.1,9 11.3,9.29 11.3,9.65C11.3,10.01 11.15,10.36 10.9,10.61L10.5,11.01C10.3,11.21 10.11,11.4 10.35,11.65C10.59,11.9 11.23,12.54 11.96,13.27C12.91,14.22 13.54,14.58 13.9,14.58C14.26,14.58 14.5,14.38 14.7,14.18L15.1,13.78C15.35,13.53 15.7,13.38 16.06,13.38C16.42,13.38 16.77,13.53 17.02,13.78L17.47,14.23C17.22,14.48 16.97,14.73 16.75,13.96M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,4A8,8 0 0,1 20,12A8,8 0 0,1 12,20A8,8 0 0,1 4,12A8,8 0 0,1 12,4Z"></path></svg></a>
              </div>
          </div>
          <div style="flex: 1; min-width: 300px;">
