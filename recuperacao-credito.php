    ...
    <div class="section-content">
      <div class="intro-section animar-ao-rolar">
        <div class="image-container">
            <img src="https://i.imgur.com/MAedYoC.png" alt="Equipe de Recuperação de Crédito">
        </div>
        <div class="text-container">
            <p>
                Na Recuperação de Crédito do MDR Advocacia, transformar dívidas em liquidez é mais que nosso objetivo: é nossa especialidade. Atuamos de forma estratégica, segura e inteligente para que cada real devido volte a gerar valor para o seu negócio.
            </p>
            <p>
                 Aliamos expertise jurídica à <strong>tecnologia de ponta.</strong> Com o apoio de Business Intelligence (BI) e plataformas de gestão, oferecemos dashboards interativos que permitem acompanhar em tempo real o desempenho e o status de cada caso. Dessa forma conseguimos mais transparência, mais agilidade e mais controle em suas mãos.
            <p>
                Não somos apenas um escritório de advocacia para recuperação de créditos. Somos parceiros do crescimento da sua empresa, recuperando ativos com ética, eficiência e inteligência, preservando sempre o que há de mais valioso: <strong>a sua marca.</strong>
            </p>
        </div>
      </div>
      ...
      <div class="professionals-grid">
        ...
        <div class="professional-card animar-ao-rolar">
            <div class="profile-pic-container">
                <img src="https://i.imgur.com/WRTFzW6.png" alt="Natália Ribeiro Linhares" class="profile-image">
        ...
        <div class="professional-card animar-ao-rolar">
             <div class="profile-pic-container">
                <img src="https://i.imgur.com/nMG1n8c.png" alt="Diego Alves do Nascimento" class="profile-image">
                <div class="social-icons">
        ...
        <div class="professional-card animar-ao-rolar">
            <div class="profile-pic-container">
                <img src="https://i.imgur.com/D8B8Fuq.png" alt="Ana Carolina Viana Nascimento" class="profile-image ana-carolina-img">
                <div class="social-icons">
        ...
        <div class="professional-card animar-ao-rolar">
            <div class="profile-pic-container">
                <img src="https://i.imgur.com/OdlQGjY.png" alt="João Vinícius Lucena Lopes" class="profile-image">
                <div class="social-icons">
            ...
            <div class="professional-card-details">
                ...
                <div class="professional-card animar-ao-rolar">
            <div class="profile-pic-container">
                <img src="https://i.imgur.com/0P3YaYO.png" alt="Melissa" class="profile-image">
                <div class="social-icons">
        ...
        <div class="professional-card animar-ao-rolar">
            <div class="profile-pic-container">
                <img src="https://i.imgur.com/ZhmEk8G.png" alt="Sthéfanie de Melo Medeiros Queiroz" class="profile-image">
                <div class="social-icons">
