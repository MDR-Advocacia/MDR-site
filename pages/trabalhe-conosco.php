<?php
ob_start();      // Inicia buffer para evitar erros de header
session_start(); // Inicia sessão para mensagens de alerta
  ...
  <script>
    ...
    <section class="contact-form-section section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <form class="php-email-form" method="POST" action="../config/envia.php" enctype="multipart/form-data">
                <fieldset>
                    
                    <?php if (isset($_SESSION['mensagem_texto'])) { ?>
                        <div class="alert alert-<?php echo $_SESSION['mensagem_tipo']; ?> text-center" role="alert">
                            <?php 
                                echo $_SESSION['mensagem_texto']; 
                                // Limpa a sessão para a mensagem não ficar aparecendo sempre
                                unset($_SESSION['mensagem_texto']);
